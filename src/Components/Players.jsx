...
function YourComponent() {
    ...
    const inputElementsRef = useRef(null);
  
    useEffect(() => {
      const playerElements = playerRef.current.getElementsByClassName("playerLabel");
      const boxElements = boxRef.current.getElementsByClassName("box");
      const optionElements = optionRef.current.getElementsByClassName("option");
      const randomiseElement = randomiseRef.current;
      const numberOfPlayersElement = numberOfPlayersRef.current;
      const printPDFElement = printPDFRef.current;
      const inputElements = inputElementsRef.current.querySelectorAll(".newPlayers");
      let addPlayers = () =>{
          let a = numberOfPlayersRef.value
              console.log(a)
      ...
      let addNames = () => {
        ...
        function printFunction(){
          ...
          numberOfPlayersRef.current.addEventListener("click", addPlayers);
          randomiseRef.current.addEventListener("click", addNames);
          printPDF.current.addEventListener("click", printFunction);
